...
enum {
  ...
  sym_string_interpolation_start = 19,
  sym_string_interpolation_end = 20,
...
enum {
  ...
  ts_external_token_string_interpolation_end = 4,
  ts_external_token_string_percent_start = 5,
  ts_external_token_string_percent_end = 6,
};
