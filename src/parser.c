...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(7),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(7),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(15),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(18),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(22),
  ...
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 1),
  [62] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 1),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 1),
  [66] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 1),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 1),
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 1),
  ...
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 5, .production_id = 2),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 5, .production_id = 2),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 4, .production_id = 1),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 4, .production_id = 1),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bool, 1),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool, 1),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_percent, 2),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_percent, 2),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 1),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 1),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_percent, 3),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_percent, 3),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(32),
  [107] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(25),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(34),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(26),
