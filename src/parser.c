...
enum {
  ...
  sym_string_simple_uninterpolation_start = 20,
  sym_program = 21,
  sym_statements = 22,
  sym_statement = 23,
  sym_expression = 24,
  ...
  sym_integer = 28,
  sym_string = 29,
  sym_string_simple = 30,
  sym_string_simple_interpolation = 31,
  sym_string_simple_interpolation_end = 32,
  sym_string_simple_uninterpolation = 33,
  sym_string_simple_uninterpolation_end = 34,
  aux_sym_program_repeat1 = 35,
  aux_sym_string_simple_repeat1 = 36,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(11),
  ...
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 1),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 1),
  ...
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 1),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 1),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_simple, 3),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_simple, 3),
  ...
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_simple_repeat1, 2), SHIFT_REPEAT(19),
  [90] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_simple_repeat1, 2), SHIFT_REPEAT(26),
  [93] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_simple_repeat1, 2), SHIFT_REPEAT(25),
  ...
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_simple_uninterpolation, 3),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_simple_uninterpolation_end, 1),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_simple_repeat1, 1),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_simple_interpolation, 3),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_simple_interpolation_end, 1),
  ...
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_directive, 1),
};
