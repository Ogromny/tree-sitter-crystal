...
enum {
  ...
  sym_string_interpolation = 34,
  sym_string_percent = 35,
  aux_sym_program_repeat1 = 36,
  aux_sym_string_literal_repeat1 = 37,
  aux_sym__string_literal_repeat1 = 38,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(15),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(18),
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(11),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(11),
  [37] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(15),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(24),
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(20),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2),
  [48] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2),
  [50] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(30),
  ...
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 1),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 1),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 3),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__string_literal, 3),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 2),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__string_literal, 2),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_percent, 3),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_percent, 3),
  ...
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 1),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 1),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 1),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_percent, 2),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_percent, 2),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bool, 1),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool, 1),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_literal_repeat1, 2),
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_literal_repeat1, 2), SHIFT_REPEAT(28),
  [112] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_literal_repeat1, 2), SHIFT_REPEAT(35),
  ...
  [129] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_literal_repeat1, 2), SHIFT_REPEAT(26),
  ...
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_literal_repeat1, 1),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_interpolation, 3),
  ...
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_directive, 1),
};
